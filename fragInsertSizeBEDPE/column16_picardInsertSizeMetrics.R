...
Usage:
  column16_picardInsertSizeMetrics_v3.R --input INPUT --orientation ORIENTATION --output OUTPUT --insertsizedf INSERT_DF [ --histogram_width HISTOGRAM_WIDTH ]
...
Options:
  ...
  --insertsizedf INSERT_DF  File to write insert size dataframe for Histogram chart later.
...
# args$insertsizedf ="/Users/minghan/bioinfoproj/fragmentomics/column16/TGL48_0011_Ct_T_PE_325_WG.merged.sorted.sub1pct.coordSortd_coordSortd.F2316_TLENgt0.NOTANDEMS.FRs.col16.insertSizeDF"
# args$insertsizedf ="/Users/minghan/bioinfoproj/fragmentomics/column16/TGL48_0011_Ct_T_PE_325_WG.merged.sorted.sub1pct.coordSortd_coordSortd.F2316_TLENgt0.NOTANDEMS.RFs.col16.insertSizeDF"
# args$insertsizedf ="/Users/minghan/bioinfoproj/fragmentomics/column16/TGL48_0011_Ct_T_PE_325_WG.merged.sorted.sub1pct.coordSortd_coordSortd.F2316_TLENgt0.TANDEMS.col16.insertSizeDF"
...
## write out insert sizes table
if (args$orientation == "FR"){
  COL_NAMES = c("insert_size", "All_Reads.fr_count")
} else if (args$orientation == "RF"){
  COL_NAMES = c("insert_size", "All_Reads.rf_count")
} else if (args$orientation == "TANDEM"){
  COL_NAMES = c("insert_size", "All_Reads.tandem_count")
}

INSERT_VEC.TABLE.OUT = INSERT_VEC.TABLE
colnames(INSERT_VEC.TABLE.OUT) = COL_NAMES
# head(INSERT_VEC.TABLE.OUT)
write.table(INSERT_VEC.TABLE.OUT, file = args$insertsizedf, sep = '\t', quote = F, row.names = F)

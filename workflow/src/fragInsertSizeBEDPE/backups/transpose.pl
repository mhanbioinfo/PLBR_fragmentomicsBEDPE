...
## courtesy of davetang.org
## USAGE: perl transpose.pl insert_size_metric_no_hist.tsv
## i.e. first `cat insert_size_metric.tsv | grep -v "^#" | head -5 > insert_size_metric_no_hist.tsv`
